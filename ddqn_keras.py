...
class DDQNAgent(object):
    def __init__(self, alpha, gamma, n_actions, epsilon, batch_size,
                 ...
                 mem_size=2500000, fname='ddqn_model.h5', replace_target=25):
        ...
        self.brain_eval = self.get_nn()
        self.brain_target = self.get_nn()
    ...
    def get_nn(self):
        ...
        model.add(tf.keras.layers.Dense(self.n_actions, activation=tf.nn.softmax))
    ...
    def learn(self):
        if self.memory.mem_cntr > self.batch_size:
            ...
            _ = self.brain_eval.fit(state, q_target)
    ...
    def load_model(self):
        self.brain_eval = load_model(self.model_file)
        self.brain_target = load_model(self.model_file)
